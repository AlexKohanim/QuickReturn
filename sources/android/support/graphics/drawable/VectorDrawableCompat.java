...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VGroup {
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            this.mThemeAttrs = null;
            this.mRotate = TypedArrayUtils.getNamedFloat(a, parser, TiC.PROPERTY_ROTATION, 5, this.mRotate);
            this.mPivotX = a.getFloat(1, this.mPivotX);
            this.mPivotY = a.getFloat(2, this.mPivotY);
            this.mScaleX = TypedArrayUtils.getNamedFloat(a, parser, TiC.PROPERTY_SCALE_X, 3, this.mScaleX);
            this.mScaleY = TypedArrayUtils.getNamedFloat(a, parser, TiC.PROPERTY_SCALE_Y, 4, this.mScaleY);
