    ...
    public static ComponentName startWakefulService(Context context, Intent intent) {
        ...
        synchronized (mActiveWakeLocks) {
            ...
            if (comp == null) {
                ...
                WakeLock wl = ((PowerManager) context.getSystemService(TiC.PROPERTY_POWER)).newWakeLock(1, "wake:" + comp.flattenToShortString());
                wl.setReferenceCounted(false);
                wl.acquire(TiAnalyticsEventFactory.MAX_GEO_ANALYTICS_FREQUENCY);
