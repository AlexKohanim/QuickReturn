...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceCallbacksApi21 implements ServiceCallbacks {
        ...
        ServiceCallbacksApi21(android.support.p000v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacks callbacks) {
    ...
    private class ServiceImplApi21 implements android.support.p000v4.media.MediaBrowserServiceCompatApi21.ServiceImplApi21 {
        ...
        public void connect(String pkg, Bundle rootHints, android.support.p000v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacks callbacks) {
            this.mServiceImpl.connect(pkg, Binder.getCallingUid(), rootHints, new ServiceCallbacksApi21(callbacks));
        }

        public void disconnect(android.support.p000v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacks callbacks) {
            this.mServiceImpl.disconnect(new ServiceCallbacksApi21(callbacks));
        }

        public void addSubscription(String id, android.support.p000v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacks callbacks) {
            this.mServiceImpl.addSubscription(id, null, new ServiceCallbacksApi21(callbacks));
        }

        public void removeSubscription(String id, android.support.p000v4.media.MediaBrowserServiceCompatApi21.ServiceCallbacks callbacks) {
