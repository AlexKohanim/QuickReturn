                ...
                if (cb != null) {
                    switch (msg.what) {
                        ...
                        case 14:
                            ...
                            Intent intent = new Intent(AndroidModule.ACTION_MEDIA_BUTTON);
                            intent.putExtra(AndroidModule.EXTRA_KEY_EVENT, keyEvent);
    ...
    public MediaSessionCompat(Context context, String tag, ComponentName mediaButtonEventReceiver, PendingIntent mbrIntent) {
        ...
        if (context == null) {
            ...
            if (mediaButtonEventReceiver != null && mbrIntent == null) {
                Intent mediaButtonIntent = new Intent(AndroidModule.ACTION_MEDIA_BUTTON);
