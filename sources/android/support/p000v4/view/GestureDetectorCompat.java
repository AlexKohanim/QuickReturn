            ...
            switch (action & 255) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(AnalyticsModule.MAX_SERLENGTH, (float) this.mMaximumFlingVelocity);
                ...
                case 6:
                    ...
                    this.mLastFocusY = focusY;
                    this.mDownFocusY = focusY;
                    this.mVelocityTracker.computeCurrentVelocity(AnalyticsModule.MAX_SERLENGTH, (float) this.mMaximumFlingVelocity);
