...
import p006ti.modules.titanium.p007ui.android.AndroidModule;
...
class AlertController {
    ...
    private static final class ButtonHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case AndroidModule.PIXEL_FORMAT_TRANSLUCENT /*-3*/:
                case -2:
                case -1:
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0191R.styleable.AlertDialog, C0191R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0191R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0191R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0191R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0191R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0191R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0191R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0191R.C0193id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0191R.C0193id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0191R.C0193id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0191R.C0193id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0191R.C0193id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0191R.C0193id.topPanel);
        View customContentPanel = customPanel.findViewById(C0191R.C0193id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0191R.C0193id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0191R.C0193id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0191R.C0193id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0191R.C0193id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0191R.C0193id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0191R.C0193id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0191R.C0193id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0191R.C0193id.scrollView);
