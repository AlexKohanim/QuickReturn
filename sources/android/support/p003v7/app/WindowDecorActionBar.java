...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0191R.C0193id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0191R.C0193id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0191R.C0193id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0191R.C0193id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0191R.styleable.ActionBar, C0191R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0191R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0191R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0191R.attr.actionBarWidgetTheme, outValue, true);
