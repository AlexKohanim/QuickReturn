...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, OnLongClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAllowTextWithIcon = res.getBoolean(C0191R.bool.abc_config_allowActionMenuItemTextWithIcon);
        TypedArray a = context.obtainStyledAttributes(attrs, C0191R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0191R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        this.mAllowTextWithIcon = getContext().getResources().getBoolean(C0191R.bool.abc_config_allowActionMenuItemTextWithIcon);
