...
class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            if (a.hasValue(C0191R.styleable.ViewBackgroundHelper_android_background)) {
                ColorStateList tint = this.mDrawableManager.getTintList(this.mView.getContext(), a.getResourceId(C0191R.styleable.ViewBackgroundHelper_android_background, -1));
                if (tint != null) {
            ...
            if (a.hasValue(C0191R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0191R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), null));
            }
        } finally {
            a.recycle();
        }
