...
public final class AppCompatDrawableManager {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0191R.C0192drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0191R.C0192drawable.abc_cab_background_internal_bg), getDrawable(context, C0191R.C0192drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    public final ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            ...
            } else if (resId == C0191R.C0192drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0191R.C0192drawable.abc_btn_borderless_material) {
    ...
    private ColorStateList createDefaultButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0191R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0191R.attr.colorAccent));
    }
