...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0191R.styleable.PopupWindow, defStyleAttr, 0);
        if (a.hasValue(C0191R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0191R.styleable.PopupWindow_overlapAnchor, false));
        }
        setBackgroundDrawable(a.getDrawable(C0191R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
