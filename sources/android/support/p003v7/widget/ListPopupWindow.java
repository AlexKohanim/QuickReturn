...
public class ListPopupWindow {
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0191R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0191R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0191R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0191R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0191R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0191R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
