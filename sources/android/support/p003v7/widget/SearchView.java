...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0191R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0191R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0191R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0191R.styleable.SearchView_layout, C0191R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0191R.C0193id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0191R.C0193id.search_edit_frame);
        this.mSearchPlate = findViewById(C0191R.C0193id.search_plate);
        this.mSubmitArea = findViewById(C0191R.C0193id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0191R.C0193id.search_button);
        this.mGoButton = (ImageView) findViewById(C0191R.C0193id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0191R.C0193id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0191R.C0193id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0191R.C0193id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0191R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0191R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0191R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0191R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0191R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0191R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0191R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0191R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0191R.styleable.SearchView_suggestionRowLayout, C0191R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0191R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0191R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0191R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0191R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0191R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0191R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0191R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0191R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0191R.dimen.abc_search_view_preferred_width);
    }
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setImeOptions(this.mCollapsedImeOptions | AndroidModule.FLAG_ACTIVITY_FORWARD_RESULT);
            this.mSearchSrcTextView.setText("");
            setIconified(false);
        }
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0191R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0191R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    public void launchQuerySearch(int actionKey, String actionMsg, String query) {
        getContext().startActivity(createIntent(AndroidModule.ACTION_SEARCH, null, null, query, actionKey, actionMsg));
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ComponentName searchActivity = searchable.getSearchActivity();
        Intent queryIntent = new Intent(AndroidModule.ACTION_SEARCH);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            if (action == null) {
                action = AndroidModule.ACTION_SEARCH;
            }
            ...
            if (data != null) {
                ...
                if (id != null) {
                    data = data + TiUrl.PATH_SEPARATOR + Uri.encode(id);
                }
            }
