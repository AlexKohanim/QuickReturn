...
public class ShareActionProvider extends ActionProvider {
    ...
    private class ShareMenuItemOnMenuItemClickListener implements OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            if (launchIntent != null) {
                ...
                if (AndroidModule.ACTION_SEND.equals(action) || AndroidModule.ACTION_SEND_MULTIPLE.equals(action)) {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(C0191R.attr.actionModeShareDrawable, outTypedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(C0191R.string.abc_shareactionprovider_share_with_application);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(C0191R.string.abc_shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            SubMenu expandedSubMenu = subMenu.addSubMenu(0, collapsedActivityCount, collapsedActivityCount, this.mContext.getString(C0191R.string.abc_activity_chooser_view_see_all));
