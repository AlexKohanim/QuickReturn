...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private final SearchManager mSearchManager = ((SearchManager) this.mContext.getSystemService(TiC.PROPERTY_SEARCH));
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0191R.C0193id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0191R.C0193id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0191R.attr.textColorSearchUrl, colorValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        ...
        try {
            ...
            String drawableUri = "android.resource://" + this.mProviderContext.getPackageName() + TiUrl.PATH_SEPARATOR + resourceId;
