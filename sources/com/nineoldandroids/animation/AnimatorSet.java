...
public final class AnimatorSet extends Animator {
                ...
                if (allDone) {
                    if (AnimatorSet.this.mListeners != null) {
                        ...
                        for (int i2 = 0; i2 < numListeners; i2++) {
                            ((AnimatorListener) tmpListeners.get(i2)).onAnimationEnd(this.mAnimatorSet);
                        }
                    }
    ...
    public void cancel() {
        ...
        if (isStarted()) {
            ...
            if (this.mListeners != null) {
                ...
                Iterator it = tmpListeners.iterator();
                while (it.hasNext()) {
            ...
            if (tmpListeners != null) {
                Iterator it3 = tmpListeners.iterator();
                while (it3.hasNext()) {
    ...
    public void start() {
        ...
        for (int i = 0; i < numSortedNodes; i++) {
            ...
            if (oldListeners != null && oldListeners.size() > 0) {
                Iterator it = new ArrayList<>(oldListeners).iterator();
                while (it.hasNext()) {
        ...
        for (int i2 = 0; i2 < numSortedNodes; i2++) {
            ...
            if (node2.dependencies == null || node2.dependencies.size() == 0) {
                ...
                for (int j = 0; j < numDependencies; j++) {
                    Dependency dependency = (Dependency) node2.dependencies.get(j);
        ...
        if (this.mStartDelay <= 0) {
            Iterator it2 = nodesToStart.iterator();
            while (it2.hasNext()) {
        ...
        if (this.mListeners != null) {
            ...
            for (int i3 = 0; i3 < numListeners; i3++) {
                ((AnimatorListener) tmpListeners.get(i3)).onAnimationStart(this);
            }
        }
        if (this.mNodes.size() == 0 && this.mStartDelay == 0) {
            this.mStarted = false;
            if (this.mListeners != null) {
                ArrayList<AnimatorListener> tmpListeners2 = (ArrayList) this.mListeners.clone();
                int numListeners2 = tmpListeners2.size();
                for (int i4 = 0; i4 < numListeners2; i4++) {
                    ((AnimatorListener) tmpListeners2.get(i4)).onAnimationEnd(this);
                }
            }
        }
    }
    ...
    public AnimatorSet clone() {
        ...
        while (it.hasNext()) {
            ...
            if (cloneListeners != null) {
                ...
                Iterator it2 = cloneListeners.iterator();
                while (it2.hasNext()) {
                ...
                if (listenersToRemove != null) {
                    Iterator it3 = listenersToRemove.iterator();
                    while (it3.hasNext()) {
                        cloneListeners.remove((AnimatorListener) it3.next());
                    }
                }
            }
        }
    ...
    private void sortNodes() {
                ...
                for (int i2 = 0; i2 < numRoots; i2++) {
                    ...
                    if (root.nodeDependents != null) {
                        ...
                        for (int j = 0; j < numDependents; j++) {
                            Node node2 = (Node) root.nodeDependents.get(j);
        ...
        for (int i3 = 0; i3 < numNodes2; i3++) {
            Node node3 = (Node) this.mNodes.get(i3);
            if (node3.dependencies != null && node3.dependencies.size() > 0) {
                ...
                for (int j2 = 0; j2 < numDependencies; j2++) {
                    Dependency dependency = (Dependency) node3.dependencies.get(j2);
