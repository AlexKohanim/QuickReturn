...
class IntKeyframeSet extends KeyframeSet {
    ...
    public int getIntValue(float fraction) {
        if (this.mNumKeyframes == 2) {
            ...
            IntKeyframe prevKeyframe = (IntKeyframe) this.mKeyframes.get(0);
            IntKeyframe nextKeyframe = (IntKeyframe) this.mKeyframes.get(1);
            ...
            IntKeyframe prevKeyframe2 = (IntKeyframe) this.mKeyframes.get(this.mNumKeyframes - 2);
            IntKeyframe nextKeyframe2 = (IntKeyframe) this.mKeyframes.get(this.mNumKeyframes - 1);
            ...
            IntKeyframe prevKeyframe3 = (IntKeyframe) this.mKeyframes.get(0);
            for (int i = 1; i < this.mNumKeyframes; i++) {
                IntKeyframe nextKeyframe3 = (IntKeyframe) this.mKeyframes.get(i);
