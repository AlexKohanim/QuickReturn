...
class ViewPropertyAnimatorHC extends ViewPropertyAnimator {
    ...
    /* renamed from: X */
    private static final int f22X = 128;

    /* renamed from: Y */
    private static final int f23Y = 256;
    ...
    private class AnimatorEventListener implements AnimatorListener, AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if ((propertyBundle.mPropertyMask & ViewPropertyAnimatorHC.TRANSFORM_MASK) != 0) {
                View v = (View) ViewPropertyAnimatorHC.this.mView.get();
                if (v != null) {
                    v.invalidate();
                }
            }
    ...
    /* renamed from: x */
    public ViewPropertyAnimator mo5669x(float value) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimator mo5671y(float value) {
    ...
    private void animatePropertyBy(int constantName, float startValue, float byValue) {
        if (this.mAnimatorMap.size() > 0) {
            ...
            while (true) {
                if (it.hasNext()) {
                    Animator runningAnim = (Animator) it.next();
