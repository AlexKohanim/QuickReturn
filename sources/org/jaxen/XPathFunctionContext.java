...
public class XPathFunctionContext extends SimpleFunctionContext {
    ...
    private void registerXPathFunctions() {
        ...
        registerFunction(null, TiC.PROPERTY_COUNT, new CountFunction());
        registerFunction(null, "false", new FalseFunction());
        registerFunction(null, "floor", new FloorFunction());
        registerFunction(null, TiC.PROPERTY_ID, new IdFunction());
        ...
        registerFunction(null, TiC.PROPERTY_NAME, new NameFunction());
        ...
        registerFunction(null, TiC.PROPERTY_NUMBER, new NumberFunction());
        registerFunction(null, TiC.PROPERTY_POSITION, new PositionFunction());
