...
public class DefaultXPathFactory implements XPathFactory {
    ...
    public NumberExpr createNumberExpr(int number) throws JaxenException {
        return new DefaultNumberExpr(new Double((double) number));
    }
    ...
    public Step createNameStep(int axis, String prefix, String localName) throws JaxenException {
        return new DefaultNameStep(getIterableAxis(axis), prefix, localName, createPredicateSet());
    }

    public Step createTextNodeStep(int axis) throws JaxenException {
        return new DefaultTextNodeStep(getIterableAxis(axis), createPredicateSet());
    }

    public Step createCommentNodeStep(int axis) throws JaxenException {
        return new DefaultCommentNodeStep(getIterableAxis(axis), createPredicateSet());
    }

    public Step createAllNodeStep(int axis) throws JaxenException {
        return new DefaultAllNodeStep(getIterableAxis(axis), createPredicateSet());
    }

    public Step createProcessingInstructionNodeStep(int axis, String piName) throws JaxenException {
        return new DefaultProcessingInstructionNodeStep(getIterableAxis(axis), piName, createPredicateSet());
    }
    ...
    public IterableAxis getIterableAxis(int axis) throws JaxenException {
        switch (axis) {
            case 1:
